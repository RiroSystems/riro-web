---
title: "Automatización que asiste: lo que aprendimos adaptando un hogar desde adentro"
description: "Home Accesible no es un nicho de mercado para nosotros. Es un problema que conocemos de primera mano. Y eso cambia todo lo que proponemos."
pubDate: 2026-06-04
author: "Riro Systems"
tags: ["home-accesible", "discapacidad", "asistencia", "criterio"]
---
...
- **Apertura de puertas sin contacto** — cerradura electrónica con automatización por presencia o por comando de voz
- **Detección de caídas** — sensores pasivos de movimiento que generan alerta si no hay actividad en un período definido
- **Alertas a familiares o cuidadores** — notificación local que no depende de internet para funcionar
- **Interfaz simplificada** — panel táctil con botones grandes, pocas opciones, feedback visual y sonoro claro
- **Control por voz con modelo local** — sin enviar audio a servidores externos
